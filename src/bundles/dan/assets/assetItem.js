...
export class AssetItem {
    ...
    setupLoader() {
        ...
        if (typeof this.value == 'function') {
            this.loader = new FunctionLoader(opts);
        }
        else if (this.checkTypes('image')) {
            this.loader = new ImageLoader(opts);
            
        }
        else if (this.checkTypes('video')) {
            this.loader = new VideoLoader(opts);
        }
        
        else if (this.checkTypes('audio')) {
            this.loader = new AudioLoader(opts);
        }
        else if (this.checkTypes('json')) {
            this.loader = new JSONLoader(opts);
        }

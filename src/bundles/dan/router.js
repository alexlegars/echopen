...
export class Router extends EventEmitter {
     ...
     */
    goto(href, target) {
        href = _.isString(href) ? href : href.getAttribute('href');
        target = _.isString(target || TARGET.SELF) ? target || TARGET.SELF : target.getAttribute('target');
     ...
     */
    update(href) {
        page.show(href, null, false, true);
    }
